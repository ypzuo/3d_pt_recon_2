...
def get_epoch_loss(val_models, val_pair_indices):
	...
	for b in xrange(batches):
		...
		_l, C, F, B, E = sess.run(runlist, feed_dict={pcl_gt:batch_gt, img_inp:batch_ip})
...
if __name__ == '__main__':
	...
	emd = tf.reduce_mean(get_emd_metrics(pcl_gt_scaled, reconstr_img_scaled, BATCH_SIZE, NUM_EVAL_POINTS))
	...
	train_vars = psgn_vars + pointnet_ae_vars
